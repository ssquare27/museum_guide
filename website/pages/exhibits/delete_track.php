...
<head>
	<title>Delete Track | The British Museum</title>
		...
		<div class="row">
			<div class="span2">
				<ul class="nav nav-list side-nav">
					...
					<li class="divider"></li>
					<li class="active"><a href="/exhibits/delete-track/">Delete a Track</a></li>    
					<li class="divider"></li>
			...
			<div class="span10">
				...
				if (!empty($_REQUEST['trackID'])) {
					...
					$getname = "SELECT Audio.audioCode, Languages.name as language, Expertise.name as expertise, Exhibits.name as exhibit
					FROM Audio
					LEFT JOIN Languages
					...
					$code = htmlentities(mysql_result($result,0,"audioCode"), ENT_QUOTES);
					$language = htmlentities(mysql_result($result,0,"language"), ENT_QUOTES);
					$expertise = htmlentities(mysql_result($result,0,"expertise"), ENT_QUOTES);
					$exhibit = htmlentities(mysql_result($result,0,"exhibit"), ENT_QUOTES);
					
			
				
					$delete = "DELETE FROM Audio WHERE trackID=$trackID";
				...
				?>
					...
					<div class="alert alert-success">
						...
						<strong>Thankyou.</strong> The <i><?php echo $language; ?></i> <i><?php echo $expertise; ?></i> Track for <i><?php echo $exhibit." (".$code.")"; ?></i> has been deleted.  View the track list below to verify.
					</div>
				<?php
				}
				?>		
				...
				<form method='post' action='?'>
					<fieldset>					
						<table class='table table-bordered'>
							...
							echo"<tr>";
								...
								echo"<td>";
									...
									echo '<input name="trackID" value="'.htmlentities(mysql_result($result,$i,"trackID"), ENT_QUOTES).'" type="radio"  onclick="document.getElementById('."'subutton'".').disabled = false" /> Delete this track';
						...
						<button id="subutton" type="submit" name="delete" class="btn btn-danger" disabled="disabled" value="submit">Delete Selected Track</button>
					</fieldset>
				</form>
