...
<head>
	<title>The British Museum | Museum of human history and culture in London</title>
...
<body>
	<?php include $_SERVER['DOCUMENT_ROOT'].'/assets/common/topnavs/none.php';?>
	<div class="main-content"><!-- full screen width -->
  <div class="container">
		<h1>Home Page</h1>
		<div class="row">
			<div class="span12">
				<p>Welcome.  Please choose from the menus at the top of the page</p>
